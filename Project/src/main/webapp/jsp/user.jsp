                ...
                <div class="d-flex flex-row justify-content-between">
                    ...
                    <div class="container m-3">
                        ...
                        <form method="post" action="/user">
                            <c:set var = "subscribe" value="${subscribe}"/>
                            <c:choose>
                                <c:when test = "${subscribe == 0}">
                                    <input name="subscribe" type="submit" class="btn btn-secondary mt-3" value = "Subscribe">
                                </c:when>
                                <c:when test = "${subscribe == 1}">
                                    <input name="unsubscribe" type="submit" class="btn btn-outline-secondary mt-3" value="Unsubscribe">
                                </c:when>
                            </c:choose>
                        </form>
                    </div>
